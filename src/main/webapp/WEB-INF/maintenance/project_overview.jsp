            ...
            <div id="page-content">
                ...
                <div class="content-header">
                    <div class="header-section">
                        ...
                        <p id="warningTitleId"><span id="warningTitle"></span></p>
                    ...
                    <div class="col-md-6">
                        <div class="block full block-alt-noborder">
                            ...
                            <div class="block-title">
                                ...
                                <a id="add_service-button" class="btn btn-sm btn-info update-button"
                                   style="display: inline-block; vertical-align: middle; margin-top: -2px;">
                                    Add Service</a>
                            </div>
...
<!-- Update Basic Information modal -->
<div id="update-basic-information-modal" class="modal fade" tabindex="-1" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal">&times;</button>
                <h3 class="modal-title">Update Project Information</h3>
            </div>
            <div class="modal-body">
                <form id="add-form" class="form-horizontal form-bordered">
                    <fieldset>
                        <div class="form-group">
                            <label class="col-md-4 control-label" for="val_project_uid">Project UID :<span
                                    class="text-danger">*</span></label>
                            <div class="col-md-6">
                                <input type="text" id="val_project_uid" name="val_project_uid"
                                       class="form-control" placeholder="Project UID..">
                            </div>
                        </div>
                        <div class="form-group">
...
<!-- END Update Basic Information modal -->
