            ...
            <div id="page-content">
                ...
                <div class="content-header">
                    <div class="header-section">
                        <h1>
                            <i class="gi gi-show_big_thumbnails"></i> Product Categories
                        </h1>
                    </div>
                </div>
                ...
                <div class="block full block-alt-noborder">
                    ...
                    <div class="table-options clearfix">
                        ...
                        <div class="btn-group btn-group-sm pull-left" data-toggle="buttons">
                            <a id="export-productcategory-button" class="btn btn-sm btn-default">
                                <i class="fa fa-print"></i> Export</a>
                        </div>
                        <div class="btn-group btn-group-sm pull-right" data-toggle="buttons">
                            <a id="add-productcategory-button" href="#add-modal" class="btn btn-sm btn-info"
                               data-toggle="modal"><i class="fa fa-plus"></i> Add Product Category</a>
                        </div>
                    </div>
                    <!-- Datatables Content -->
                ...
                <form id="add-form" class="form-horizontal form-bordered">
                    <fieldset>
                        <div class="form-group">
                            <label class="col-md-4 control-label" for="val_productcategory_name">Product Category Name <span
                                    class="text-danger">*</span></label>
                            <div class="col-md-6">
                                <input type="text" id="val_productcategory_name" name="val_productcategory_name"
...
<div id="view-modal" class="modal fade" tabindex="-1" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal">&times;</button>
                <h3 class="modal-title" style="display: inline-block; margin: 0; margin-right: 10px;">View Product Category</h3>
            ...
            <div class="modal-body">
                <form id="update-form" class="form-horizontal form-bordered">
                    <fieldset>
                        <div id="productCategory-id" class="form-group">
                            <label class="col-md-4 control-label" for="val_vproductcategory_id">Product Category ID <span
                                    class="text-danger">*</span></label>
                            <div class="col-md-6">
                                <input type="text" id="val_vproductcategory_id" name="val_vproductcategory_id"
                                       class="form-control" placeholder="Product Category ID.." readonly>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-md-4 control-label" for="val_vproductcategory_name">Product Category Name <span
                                    class="text-danger">*</span></label>
                            <div class="col-md-6">
                                <input type="text" id="val_vproductcategory_name" name="val_vproductcategory_name"
                                       class="form-control" placeholder="Product Category Name..">
                            </div>
                        </div>
                        <div class="form-group">
...
<script src="${pageContext.request.contextPath}/asset/js/product-categories.js"></script>
</body>
