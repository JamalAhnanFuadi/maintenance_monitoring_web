...
public class MasterSalesLevelController extends BaseController {
    public MasterSalesLevelController() {
    ...
    public List<User> getUserList() {
        ...
        String sql = "Select uid, level_name, description, create_dt, modify_dt from master_sales_level";
    ...
    public boolean create(User user) {
        ...
        final String sql = "INSERT INTO [master_sales_level] (uid, level_name, description ,create_dt, modify_dt)values (:uid, :level_name, :description ,:create_dt, :modify_dt)";
    ...
    public boolean delete(String uid) {
        ...
        start(methodName);
        boolean result = false;
        final String sql = "DELETE FROM [master_sales_level] WHERE uid = :uid";
        try (Handle h = getHandle(); Update u = h.createUpdate(sql)) {
            u.bind("uid", uid);
            result = executeUpdate(u);
        } catch (Exception ex) {
    ...
    public User getUserByUid(String uid) {
        ...
        User user = new User();
        final String sql = "SELECT uid, level_name, description ,create_dt, modify_dt from master_sales_level" +
                " FROM master_sales_level WHERE uid = :uid";
