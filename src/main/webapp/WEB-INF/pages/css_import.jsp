...
<link rel="stylesheet" href="${pageContext.request.contextPath}/asset/css/plugins.css">
...
<link rel="stylesheet" href="${pageContext.request.contextPath}/asset/css/themes.css">
<!-- END Stylesheets -->

<!-- Modernizr (browser feature detection library) -->
<script src="${pageContext.request.contextPath}/asset/js/vendor/modernizr.min.js"></script>
