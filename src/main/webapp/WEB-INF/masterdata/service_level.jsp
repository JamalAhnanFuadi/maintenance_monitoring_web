            ...
            <div id="page-content">
                ...
                <div class="content-header">
                    <div class="header-section">
                        <h1>
                            <i class="gi gi-show_big_thumbnails"></i> Service Levels
                        </h1>
                    </div>
                </div>
                ...
                <div class="block full block-alt-noborder">
                    ...
                    <div class="table-options clearfix">
                        ...
                        <div class="btn-group btn-group-sm pull-left" data-toggle="buttons">
                            <a id="export-servicelevel-button" class="btn btn-sm btn-default">
                                <i class="fa fa-print"></i> Export</a>
                        </div>
                        <div class="btn-group btn-group-sm pull-right" data-toggle="buttons">
                            <a id="add-servicelevel-button" href="#add-modal" class="btn btn-sm btn-info"
                               data-toggle="modal"><i class="fa fa-plus"></i> Add service Level</a>
                        </div>
                    </div>
                    <!-- Datatables Content -->
                    <div class="table-responsive">
                        <table id="service-level-table"
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h3 class="modal-title">Add Service Levels</h3>
            </div>
            <div class="modal-body">
                <form id="add-form" class="form-horizontal form-bordered">
                    <fieldset>
                        <div class="form-group">
                            <label class="col-md-4 control-label" for="val_servicelevel_name">Service Level Name <span
                                    class="text-danger">*</span></label>
                            <div class="col-md-6">
                                <input type="text" id="val_servicelevel_name" name="val_servicelevel_name"
                                       class="form-control" placeholder="Service Level Name..">
                            </div>
                        </div>
                        <div class="form-group">
...
<div id="view-modal" class="modal fade" tabindex="-1" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal">&times;</button>
                <h3 class="modal-title" style="display: inline-block; margin: 0; margin-right: 10px;">View Service Levels</h3>
            ...
            <div class="modal-body">
                <form id="update-form" class="form-horizontal form-bordered">
                    <fieldset>
                        <div id="servicelevel-id" class="form-group">
                            <label class="col-md-4 control-label" for="val_vservicename_id">Service Level ID <span
                                    class="text-danger">*</span></label>
                            <div class="col-md-6">
                                <input type="text" id="val_vservicename_id" name="val_vservicename_id"
                                       class="form-control" placeholder="Service Level ID.." readonly>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-md-4 control-label" for="val_vservicelevel_name">Service Level Name <span
                                    class="text-danger">*</span></label>
                            <div class="col-md-6">
                                <input type="text" id="val_vservicelevel_name" name="val_vservicelevel_name"
                                       class="form-control" placeholder="Service Level Name..">
                            </div>
                        </div>
                        <div class="form-group">
...
<script src="${pageContext.request.contextPath}/asset/js/service-level.js"></script>
</body>
