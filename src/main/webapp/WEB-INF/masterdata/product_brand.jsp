            ...
            <div id="page-content">
                ...
                <div class="content-header">
                    <div class="header-section">
                        <h1>
                            <i class="gi gi-show_big_thumbnails"></i> Product Brands
                        </h1>
                    </div>
                </div>
                ...
                <div class="block full block-alt-noborder">
                    ...
                    <div class="table-options clearfix">
                        ...
                        <div class="btn-group btn-group-sm pull-left" data-toggle="buttons">
                            <a id="export-productbrand-button" class="btn btn-sm btn-default">
                                <i class="fa fa-print"></i> Export</a>
                        </div>
                        <div class="btn-group btn-group-sm pull-right" data-toggle="buttons">
                            <a id="add-productbrand-button" href="#add-modal" class="btn btn-sm btn-info"
                               data-toggle="modal"><i class="fa fa-plus"></i> Add Product Brand</a>
                        </div>
                    </div>
                    <!-- Datatables Content -->
                    <div class="table-responsive">
                        <table id="product-brand-table"
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h3 class="modal-title">Add Product Brand</h3>
            </div>
            <div class="modal-body">
                <form id="add-form" class="form-horizontal form-bordered">
                    <fieldset>
                        <div class="form-group">
                            <label class="col-md-4 control-label" for="val_productbrand_name">Product Brand Name <span
                                    class="text-danger">*</span></label>
                            <div class="col-md-6">
                                <input type="text" id="val_productbrand_name" name="val_productbrand_name"
                                       class="form-control" placeholder="Product Brand Name..">
                            </div>
                        </div>
                        <div class="form-group">
...
<div id="view-modal" class="modal fade" tabindex="-1" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal">&times;</button>
                <h3 class="modal-title" style="display: inline-block; margin: 0; margin-right: 10px;">View Product Brand</h3>
            ...
            <div class="modal-body">
                <form id="update-form" class="form-horizontal form-bordered">
                    <fieldset>
                        <div id="productbrand-id" class="form-group">
                            <label class="col-md-4 control-label" for="val_vproductbrand_id">Product Brand ID <span
                                    class="text-danger">*</span></label>
                            <div class="col-md-6">
                                <input type="text" id="val_vproductbrand_id" name="val_vproductbrand_id"
                                       class="form-control" placeholder="Product Brand ID.." readonly>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-md-4 control-label" for="val_vproductbrand_name">Product Brand Name <span
                                    class="text-danger">*</span></label>
                            <div class="col-md-6">
                                <input type="text" id="val_vproductbrand_name" name="val_vproductbrand_name"
                                       class="form-control" placeholder="Product Brand Name..">
                            </div>
                        </div>
                        <div class="form-group">
...
<script src="${pageContext.request.contextPath}/asset/js/product-brands.js"></script>
</body>
