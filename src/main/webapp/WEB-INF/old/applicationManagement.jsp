        ...
        <table id="applicationDT" class="table table-hover" style="width: 100%;">
         <thead>
          <tr>
           ...
           <th class="tableheader_serverName">Server Name</th>
           ...
           <th class="tableheader_status">Status</th>
          ...
          <form class="form-horizontal" onsubmit="main.add()">
           <div class="form-group">
            ...
            <div class="col-md-8 row">
             <div class="col-md-12">
              <input type="text" class="form-control" v-model="newApplication.name" />
             </div>
             <span class="col-md-12"> The application name should be the same as what is configured in the IDG
              universe. </span>
            </div>
           </div>
           <div class="form-group">
            ...
            <div class="col-md-8 row">
             <div class="col-md-12">
              <select class="form-control" id="newServerSelect" v-model="newApplication.server">
           ...
           <div class="form-group">
            ...
            <div class="col-md-8 row">
             <div class="col-md-12">
              <select class="form-control" id="newConfigurationSelect" v-model="newApplication.configName">
           ...
           <div class="form-group">
            <label class="control-label col-md-3"> Application Owner Emails </label>
            <div class="col-md-8 row">
             <div class="col-md-12">
              <vue-tags-input placeholder="" v-model="newApplication.email" :tags="newApplication.emails"
               :validation="emailValidation" @tags-changed="email => newApplication.emails = email"
               :allow-edit-tags="true" />
             </div>
             <span class="col-md-12"> e.g. owner1@kbtg.tech, owner2@kbtg.tech </span>
            </div>
           </div>
           <div class="form-group">
            ...
            <div class="col-md-8 row">
             <div class="col-md-12">
              <vue-tags-input placeholder="" v-model="newApplication.attribute" :tags="newApplication.attributes"
               @tags-changed="attr => newApplication.attributes = attr" :allow-edit-tags="true" />
             </div>
             <span class="col-md-12"> e.g. Department, Job Code </span>
            </div>
           </div>
           <div class="form-group">
            ...
            <div class="col-md-8 row">
             <div class="col-md-12">
              <input type="text" class="form-control" id="newMailSubject" v-model="newApplication.mailSubject" />
             </div>
            </div>
           </div>
           <div class="form-group">
            ...
            <div class="col-md-8 row">
             <div class="col-md-12">
              <textarea class="form-control" id="newMailBody" v-model="newApplication.mailBody"></textarea>
             </div>
            </div>
           </div>
         ...
         <div class="x_content">
          <form class="form-horizontal" onsubmit="main.remove()">
           <div class="form-group text-danger remove-app-padding">
            <h5>
             Are you sure you want to remove application <strong>{{applicationName}}</strong> ?
            </h5>
       ...
       <div class="modal-body">
        <div class="container-fluid">
         <div class="x_title">
          ...
          <h3 class="modal-title">Update Application {{applicationName}}</h3>
         </div>
         <div class="x_content">
          <form class="form-horizontal" onsubmit="main.updateApplication()">
           <div class="form-group">
            ...
            <div class="col-md-8 row">
             <div class="col-md-12">
              <input type="text" class="form-control" v-model="applicationName" disabled />
             </div>
             <span class="col-md-12"> The application name should be the same as what is configured in the IDG
              universe. </span>
            </div>
           ...
           <div class="form-group">
            ...
            <div class="col-md-8 row">
             <div class="col-md-12">
              <input type="text" class="form-control" v-model="configurationName" disabled />
             </div>
            </div>
           </div>
           <div class="form-group">
           ...
           <div class="form-group">
            ...
            <div class="col-md-8 row">
             <div class="col-md-12">
              <vue-tags-input placeholder="" v-model="recipients" :tags="recipientss" :validation="emailValidation"
               @tags-changed="recipient => recipientss = recipient" :allow-edit-tags="true" />
             </div>
             <span class="col-md-12"> e.g. owner1@kbtg.tech, owner2@kbtg.tech </span>
            </div>
           </div>
           <div class="form-group">
            ...
            <div class="col-md-8 row">
             <div class="col-md-12">
              <vue-tags-input placeholder="" v-model="attributes" :tags="attributess"
               @tags-changed="attr => attributess = attr" :allow-edit-tags="false" :disabled="true" class="disabled" />
             </div>
             <span class="col-md-12"> e.g. Department, Job Code </span>
            </div>
           </div>
           ...
           <div class="ln_solid"></div>
           <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3 button-align">
            <button type="button" class="btn btn-sm btn-info iconed-button" onclick="main.updateApplication()">
